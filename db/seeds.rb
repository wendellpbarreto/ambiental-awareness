...
3.times do |i| 
	...
	10.times do |v|
		State.create(value: rand(80) - 40, sensor: temperature_sensor)
		State.create(value: rand(500), sensor: air_pollution_sensor)
		State.create(value: rand(1), sensor: fire_presence_sensor)
	end
end
